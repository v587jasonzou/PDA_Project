...
import sbgl3.yunda.module.upparts.di.component.DaggerUpPartsListComponent;
...
import sbgl3.yunda.module.upparts.mvp.presenter.UpPartsListPresenter;
 ...
 * @Data 2018/11/28
 */
public class UpPartsListActivity extends BaseActivity<UpPartsListPresenter> implements UpPartsListContract.View {
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerUpPartsListComponent //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .upPartsListModule(new UpPartsListModule(this))
                .build()
                .inject(this);
    }
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_up_parts_list; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        ...
        svRefresh.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshLayout) {
                if (mPresenter != null) {
                    showLoading();
                    mPresenter.getPartsList("","0201",false);
                }
            }
        });
        ...
        adapter.setOnItemClickListener(new DefaultAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int viewType, Object data, int position) {
                ...
                if(bean!=null){
                    Intent intent = new Intent(UpPartsListActivity.this,UpPartsEditActivity.class);
        ...
        if (messageBean != null && "scan".equals(messageBean.getMsgType())) {
            if (messageBean.getMsgInfo() != null) {
                if (mPresenter != null) {
                    ...
                    showLoading();
                    mPresenter.getPartsList(messageBean.getMsgInfo(),"0103",true);
                }
            }
        }
    }
        ...
        if (requestCode == REQUEST_CODE_SCAN && resultCode == RESULT_OK) {
            if (data != null) {
                ...
                if (mPresenter != null) {
                    scancode = content;
                    showLoading();
                    mPresenter.getPartsList(content,"0103",true);
                }
            }
        }
    }
    @OnClick(R.id.btAdd)
    void Scan(){
        Intent intent = new Intent(UpPartsListActivity.this, CaptureActivity.class);
