...
public class LoginActivityModel extends BaseModel implements LoginActivityContract.Model {
    ...
    @Override
    public Observable<BaseResponsBean<LoginReponsBody>> Login(String username, String password) {
        return mRepositoryManager.obtainRetrofitService(LoginApi.class).Login(username,password)
                .subscribeOn(Schedulers.io());
    }

    @Override
    public Observable<BaseResponsBean> LoginFirst(String username, String password) {
