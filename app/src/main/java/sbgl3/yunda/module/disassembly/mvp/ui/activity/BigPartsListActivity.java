...
import sbgl3.yunda.module.disassembly.di.component.DaggerBigPartsListComponent;
...
import sbgl3.yunda.module.disassembly.mvp.presenter.BigPartsListPresenter;
 ...
 * @Data 2018/11/28
 */
public class BigPartsListActivity extends BaseActivity<BigPartsListPresenter> implements BigPartsListContract.View {
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerBigPartsListComponent //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .bigPartsListModule(new BigPartsListModule(this))
                .build()
                .inject(this);
    }
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_big_parts_list; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickListener(new DefaultAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int viewType, Object data, int position) {
                Intent intent = new Intent(BigPartsListActivity.this,DisassemblyListActivity.class);
    ...
    public void isScanSuccess(BigPartsBean bean) {
        if(bean!=null){
            ...
            Intent intent = new Intent(BigPartsListActivity.this,GetPartsEditActivity.class);
    ...
    @OnClick(R.id.btAdd)
    void Scan(){
        Intent intent = new Intent(BigPartsListActivity.this, CaptureActivity.class);
