...
@ActivityScope
public class AssemblyBigPartsListPresenter extends BasePresenter<AssemblyBigPartsListContract.Model, AssemblyBigPartsListContract.View> {
    @Inject
    ...
    @Inject
    public AssemblyBigPartsListPresenter(AssemblyBigPartsListContract.Model model, AssemblyBigPartsListContract.View rootView) {
